...
<html lang="<?php echo(($langles)?'en':'es');?>">
    <head>
        ...
        lagrid_datatable("viae_ptdas","ptda_import.php",1); // nom de la base, php de execució x clic, selecció de registre 1/0
        ?>
    </head>
    <body>
        <?php 
            ...
            menutct();
            // -- Page Title -->
            pagetitle("Agrupacion de IMPORTACION",$laref,"IMPORT File",$laref,"schedule"); 
        ?>
<div class="container text-lext">
  ...
  <button type="button" class="btn btn-info pull-left" data-toggle="collapse" data-target="#hea2">Viaje</button>
</div>
<div class="container text-lext">
