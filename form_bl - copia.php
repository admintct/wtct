    ...
    <body>
        ...
        <div class="container">
            <div class="class="col-xs-12 col-centered"" style="padding: 20px 0px 20px 20px;">
                <form action="modbl.php" method="post">
                <table width="900px" border="1px">
                    ...
                    <tr height="130px" align="left" valign="top"  style="border-left: 1px solid #fff;border-right: 1px solid #fff;">
                        <td colspan="6">
                            ...
                            <div class="bl_ship"><textarea placeholder="Shipper" name="shipper" rows="4"><?php echo utf8_encode(trim($elshipper)); ?></textarea></div>
                    ...
                    <tr height="130px" align="left" valign="top" style="border-left: 1px solid #fff;">
                        <td colspan="6">
                            ...
                            <div class="bl_ship"><textarea placeholder="Consignee" name="consignee" rows="4"><?php echo utf8_encode(trim($elconsig)); ?></textarea></div>
                    ...
                    <tr height="110px" align="left" valign="top" style="border-left: 1px solid #fff;">
                        <td colspan="6">
                            ...
                            <div class="bl_ship"><textarea style="height:88px;" placeholder="Notify party" name="notify" rows="3"><?php echo utf8_encode(trim($elnotify)); ?></textarea></div>
                    ...
                    <tr height="40px" align="left" valign="top">
                        ...
                        <td colspan="4" style="border-right: 1px solid #fff;">
                            ...
                            <div class="bl_ship"><input style="width:200px;" name="pol" type="text" value="<?php echo $ptda['bl_pol']; ?>"></div>
                    ...
                    <tr height="40px" align="left" valign="top">
                        <td colspan="2" style="border-left: 1px solid #fff;">
                            ...
                            <div class="bl_ship"><input style="width:200px;" name="pod" type="text" value="<?php echo $ptda['blpod']; ?>"></div>
                            <?php echo html_input_hidden('xpod',$ptda['blpod']); ?>
                        </td>
                        <td colspan="5">
                            <div class="bltitol">Place of delivery</div>
                            <div class="bl_ship"><input style="width:200px;" name="delivery" type="text" value="<?php echo $ptda['blfpod']; ?>"></div>
                            <?php echo html_input_hidden('xdelivery',$ptda['blfpod']); ?>
                        </td>
                        <td>
                            <div class="bltitol">Freight payable at</div>
                            <div class="bl_ship"><input style="width:120px;" name="payable" type="text" value="<?php echo $payable; ?>"></div>
                    ...
                    <tr height="280px" align="left" valign="top">
                        <td colspan="3" rowspan="3" style="border-left: 1px solid #fff;">
                            <div class="bl_marks"><textarea style="width:250px;" placeholder="Marks & numbers" name="marks" rows="4"><?php echo (($zzz)?$ptda['mmarcas']:$ptda['fmmarcas']); ?></textarea></div>
                            <?php echo html_input_hidden('xmarks',(($zzz)?$ptda['mmarcas']:$ptda['fmmarcas'])); ?>
                        </td>
                        <td colspan="2" rowspan="3">
                            <div class="bl_marks"><textarea style="width:86px;" placeholder="Pkgs." name="units" rows="4"><?php echo $paquets; ?></textarea></div>
                            <?php echo html_input_hidden('xunits',$paquets); ?>
                        </td>
                        <td colspan="5" rowspan="3">
                            <div class="bl_marks"><textarea style="width:380px;" placeholder="Goods & Packages" name="goods" rows="4"><?php echo $mimerc; ?></textarea></div>
                            <?php echo html_input_hidden('xgoods',$mimerc); ?>
                        </td>
                        <td style="border-right: 1px solid #fff;">
                            <div class="bl_marks"><textarea style="width:110px;height:270px;" placeholder="KGs" name="kgs" rows="4"><?php echo $gross; ?></textarea></div>
                    ...
                    <tr height="30px" align="left" valign="top">
                        <td style="border-right: 1px solid #fff;">
                            <div style="margin-top: 5px;" class="bl_ship"><input style="width:140px;" name="volume" type="text" value="<?php echo number_format($ptdab['bl_cbm'],3,',','.').' CBM'; ?>"></div>
